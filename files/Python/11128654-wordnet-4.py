...
class Lemma(_WordNetObject):
    ...
    def _related(self, relation_symbol):
        ...
        return [get_synset(pos, offset)._lemmas[lemma_index]
    ...
    def _synset_from_pos_and_line(self, pos, data_file_line):
        ...
        try:
            ...
            for _ in xrange(n_lemmas):
                ...
                synset._lemma_names.append(lemma.name)
            ...
            for _ in xrange(n_pointers):
                ...
                if lemma_ids_str == '0000':
                    ...
                    source_lemma_name = synset._lemmas[source_index].name
        ...
        lemma_name = synset._lemmas[0].name.lower()
